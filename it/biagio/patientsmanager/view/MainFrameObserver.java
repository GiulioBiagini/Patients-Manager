...
{
	public void onFilterPatients(String text, boolean lastVisitCurrentYear);
	
	public void onFilterDoctors(String text);
	
	public void onAddPatient(Patient patient);
	
	public void onAddDoctor(Doctor doctor);
	
	public void onEditPatient(Patient oldPatient, Patient newPatient);
	
	public void onEditDoctor(Doctor oldDoctor, Doctor newDoctor);
