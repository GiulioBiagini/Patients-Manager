...
public class ShowFemalePatientPanel extends APanel
{
	...
	public ShowFemalePatientPanel() {
		super(
			Const.SHOW_FEMALE_PANEL_TITLE_ICON,
			Const.FEMALE_FOREGROUND_COLOR,
			Const.FEMALE_BACKGROUND_COLOR,
			Const.FEMALE_BORDER_COLOR
		);
